...
public class UserController extends AbstractController<User, UserResponse, UserRequest> {
    ...
    public UserController(UserRequestMapper requestMapper, UserResponseMapper responseMapper, UserService userService) {
        super(requestMapper, responseMapper, userService);
    }
}
